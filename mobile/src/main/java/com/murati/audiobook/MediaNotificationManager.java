...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private static final String CHANNEL_ID = "com.murati.audiobook.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "com.murati.audiobook.pause";
    public static final String ACTION_PLAY = "com.murati.audiobook.play";
    public static final String ACTION_PREV = "com.murati.audiobook.prev";
    public static final String ACTION_NEXT = "com.murati.audiobook.next";
    public static final String ACTION_STOP = "com.murati.audiobook.stop";
    public static final String ACTION_STOP_CASTING = "com.murati.audiobook.stop_cast";
    ...
    private Notification createNotification() {
        ...
        android.app.RemoteServiceException: Bad notification posted from package com.murati.audiobook:
        Couldn't expand RemoteViews for: StatusBarNotification
        (pkg=com.murati.audiobook user=UserHandle{0} id=412 tag=null score=0 key=0|com.murati.audiobook|412|null|10108: Notification(pri=0 contentView=com.murati.audiobook/0x109007f vibrate=null sound=null defaults=0x0 flags=0x8 color=0xffbe0224 category=transport actions=3 vis=PUBLIC))
         */
