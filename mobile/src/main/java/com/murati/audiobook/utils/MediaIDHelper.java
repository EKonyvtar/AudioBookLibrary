...
public class MediaIDHelper {
    ...
    public static final String EXTRA_MEDIA_ID_KEY = "com.murati.audiobook.MEDIA_ID";
    ...
    public static final String MEDIA_ID_BY_RECOMMENDATION = "__BY_RECOMMENDATION__";
